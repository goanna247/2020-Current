...
PIDScheduledController::PIDScheduledController(PIDGains gains, double setpoint) : _gains(gains), _filterPos(wml::control::LinearFilter::MovingAverage(20)), _filterVel(wml::control::LinearFilter::MovingAverage(20)), _setpoint(setpoint), _lastError(0) {}
